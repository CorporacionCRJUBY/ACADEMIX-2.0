...
const create = async (req, res, next) => {
  try {
    const data = await gransifService.create(req.body, req.user);
...
const update = async (req, res, next) => {
  try {
    const data = await gransifService.update(req.params.id, req.body, req.user);
    res.json({ success: true, data });
  } catch (error) {
    next(error);
  }
...
const softDelete = async (req, res, next) => {
  try {
    await gransifService.softDelete(req.params.id, req.user);
...
const activate = async (req, res, next) => {
  try {
    const data = await gransifService.activate(req.params.id, req.user);
    res.json({ success: true, data });
  } catch (error) {
    next(error);
  }
